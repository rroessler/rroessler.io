...
[Aster](https://github.com/rroessler/aster) is an efficient, compact and robust cross-platform C++ globbing library. It provides a fast baseline globbing function and an optimized walker for traversing the file-system through globs.
...
For more information, check out the [GitHub project](https://github.com/rroessler/aster) or the post I made on [faster globbing](../../posts/2025-11-06/faster-globbing.mdx) optimizations.
